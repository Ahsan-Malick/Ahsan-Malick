...
🌐 Experienced in designing performant, user-focused apps with modern frameworks and tools.

🤖 I enjoy working at the intersection of AI, automation, and software engineering, applying problem-solving and system design to create impactful digital products.

🔑 Core Skills:

Frontend: Next.js, TypeScript, React

Backend: Python (FastAPI), REST APIs, Automation

AI/ML: Custom ML Models, AI API Integration

Other: System Design, Scalability, Performance
